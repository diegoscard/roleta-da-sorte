...
export const PRIZES: Prize[] = [
  ...
  { id: 2, label: 'R$ 150', isWin: true, color: '#EAB308', amount: 500 },
  ...
  { id: 8, label: 'R$ 200', isWin: true, color: '#FACC15', amount: 1000 },
...
export const SPIN_DURATION = 9000; // Aumentado para 9 segundos
